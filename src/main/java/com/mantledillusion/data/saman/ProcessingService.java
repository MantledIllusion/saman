...
public interface ProcessingService {
	...
	default <SourceType, TargetType> TargetType process(SourceType source, Class<TargetType> targetType) {
		return source == null ? null
				: processStrictly((Class<? super SourceType>) source.getClass(), source, targetType, null);
	}
	 ...
	 *            The target type to process to; might <b>not</b> be null.
	 * @param context
	 *            Predefined {@link ProcessingContext}; might be null.
	 * @return The processed target object, always null if the source is null and
	 *         possibly null if the {@link Processor}'s result is null
	 */
	@SuppressWarnings("unchecked")
	default <SourceType, TargetType> TargetType process(SourceType source, Class<TargetType> targetType,
		...
		return source == null ? null
				: processStrictly((Class<? super SourceType>) source.getClass(), source, targetType, context);
	}
	 ...
	 *         result is null
	 */
	default <SourceType, TargetType> TargetType processNull(Class<SourceType> sourceType, Class<TargetType> targetType,
			ProcessingContext context) {
	 ...
	 *         result is null
	 */
	default <SourceType, TargetType> TargetType processStrictly(Class<SourceType> sourceType, SourceType source,
			Class<TargetType> targetType) {
	...
	default <SourceType, TargetType> List<TargetType> processList(List<SourceType> source,
			Class<TargetType> targetType) {
		return source == null ? null : processInto(source, new ArrayList<>(), targetType, null);
	}
	 ...
	 *         object list was null
	 */
	default <SourceType, TargetType> List<TargetType> processList(List<SourceType> source, Class<TargetType> targetType,
			ProcessingContext context) {
	 ...
	 *         object set was null
	 */
	default <SourceType, TargetType> Set<TargetType> processSet(Set<SourceType> source, Class<TargetType> targetType) {
		return source == null ? null : processInto(source, new HashSet<>(), targetType, null);
	}
	 ...
	 *         collection was null
	 */
	default <SourceType, SourceCollectionType extends Collection<SourceType>, TargetCollectionType extends Collection<TargetType>, TargetType> TargetCollectionType processInto(
	...
	default <SourceType, TargetType> List<TargetType> processListStrictly(Class<SourceType> sourceType,
		...
		return source == null ? null : processStrictlyInto(sourceType, source, new ArrayList<>(), targetType, null);
	}
	 ...
	 */
	default <SourceType, TargetType> List<TargetType> processListStrictly(Class<SourceType> sourceType,
			List<SourceType> source, Class<TargetType> targetType, ProcessingContext context) {
	...
	default <SourceType, TargetType> Set<TargetType> processSetStrictly(Class<SourceType> sourceType,
		...
		return source == null ? null : processStrictlyInto(sourceType, source, new HashSet<>(), targetType, null);
	}
	 ...
	 */
	default <SourceType, TargetType> Set<TargetType> processSetStrictly(Class<SourceType> sourceType,
			Set<SourceType> source, Class<TargetType> targetType, ProcessingContext context) {
	 ...
	 *         collection was null
	 */
	default <SourceType, SourceCollectionType extends Collection<SourceType>, TargetCollectionType extends Collection<TargetType>, TargetType> TargetCollectionType processStrictlyInto(
