...
public class MapConversionTest extends AbstractConversionTest {
	...
	public void testConvertNullMap() {
		assertNull(this.service.processMap(null, String.class, TargetPojo.class));
		assertNull(this.service.processMapStrictly(String.class, SourcePojo.class, null, String.class, TargetPojo.class));
	}
	...
	public void testConvertMapNulls() {
		...
		sourceMap.put(TEST_ID_B, SOURCE_B);
		assertEquals(null, this.service.processMap(sourceMap, String.class, TargetPojo.class).get(null));
		assertEquals(TARGET_NULL, this.service.processMapStrictly(String.class, SourcePojo.class, sourceMap, String.class, TargetPojo.class).get(null));
	}
